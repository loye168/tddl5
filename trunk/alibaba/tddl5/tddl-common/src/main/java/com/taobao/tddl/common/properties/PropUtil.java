...
public class PropUtil {
    ...
    /**
     * Converts the given duration (interval value plus unit) to milliseconds, ensuring that any given value greater
     * than zero converts to at least one millisecond to avoid a zero millisecond result, since Object.wait(0) waits
     * forever.
     * 
     * @throws IllegalArgumentException if the duration argument is illegal. Thrown via API setter methods such as
     ...
     * 
     * @throws IllegalArgumentException if the unit is null. Thrown via API getter methods such as
     ...
     * 
     * @throws IllegalArgumentException if the duration string is illegal. Thrown via the Enviornment ctor and
     * setMutableConfig, and likewise for a ReplicatedEnvironment.
     */
    ...
    /**
     * Support for conversion of IEEE time units. Although names are defined in uppercase, we uppercase the input string
     * before calling IEEETimeUnit.valueOf, in order to support input names in both upper and lower case.
     */
