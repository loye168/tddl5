...
public interface DataType<DATA> extends Comparator<Object> {
    ...
    public static final int                          UNDECIDED_SQL_TYPE = 10099;               // 未决类型
    ...
    public static final DataType<Long>               YearType           = new LongType();
    ...
    public static final DataType<BigDecimal>         BigBitType         = new BigBitType();
    public static final DataType<byte[]>             BytesType          = new BytesType();
    public static final DataType<Byte>               ByteType           = new ByteType();
    public static final DataType                     UndecidedType      = new UndecidedType();
