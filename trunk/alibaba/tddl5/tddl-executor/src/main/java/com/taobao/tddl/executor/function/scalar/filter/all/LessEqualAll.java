package com.taobao.tddl.executor.function.scalar.filter.all;
...
public class LessEqualAll extends Filter {

    @Override
    public String[] getFunctionNames() {
        return new String[] { OPERATION.LT_EQ_ALL.getOPERATIONString() };
    }
