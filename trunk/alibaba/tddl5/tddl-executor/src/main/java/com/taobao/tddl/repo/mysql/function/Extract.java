...
public class Extract implements FunctionStringConstructor {
    ...
    public String constructColumnNameForFunction(IDataNodeExecutor query, boolean bindVal,
        ...
        sb.append(IFunction.BuiltInFunction.EXTRACT).append("(");
    ...
    public String[] getFunctionNames() {
        return new String[] { IFunction.BuiltInFunction.EXTRACT };
    }
}
