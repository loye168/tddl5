				...
				function(returnedJson) {
					...
					if (returnedJson[0] != null)
						for ( var i = 0; i < returnedJson.length; i++) {
							...
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["group"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["url"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["user"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["type"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["init"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["min"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["max"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["idle"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["maxWait"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["active"];
							newRow.insertCell(tmp++).innerHTML = returnedJson[i]["pooling"];
