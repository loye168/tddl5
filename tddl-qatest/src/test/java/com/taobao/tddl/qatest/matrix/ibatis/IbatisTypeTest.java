...
public class IbatisTypeTest {
    ...
    private void rowEquals(NormalTblRow row, NormalTblRow rowMysql) {
        ...
        // TODO 暂时无法解决tinyint(1)问题,jdbc getObject()默认返回了boolean
        Assert.assertEquals(rowMysql.getTinyintr_1(), row.getTinyintr_1());
        ...
        Assert.assertEquals(rowMysql.getBitr_8(), row.getBitr_8());
