package com.taobao.tddl.repo.mysql.common;
...
public class ResultSetWrapper implements ResultSet {
    ...
    private My_JdbcHandler jdbcHandler;

    public ResultSetWrapper(ResultSet rs, My_JdbcHandler my_JdbcHandler){
        this.rs = rs;
        this.jdbcHandler = my_JdbcHandler;
    }
