...
public class CobarDaoTest extends SysAdminTest {
    ...
    private static final Logger logger        = LoggerFactory.getLogger(CobarDaoTest.class);
    ...
    public void testAddManyCobar() {
        ...
        // int activeCobarNum = cobarDao.getCobarCountByStatus(1L,
    ...
    public void testModifyCobar() {
        ...
        String destStatus = ConstantDefine.ACTIVE.equals(cobar.getStatus()) ? ConstantDefine.IN_ACTIVE : ConstantDefine.ACTIVE;
    ...
    public void testGetCobarListbyStatus() {
        ...
        // Assert.assertEquals(activeCobarNum,
        // cobarDao.getCobarCountByStatus(testClusterId,
        // ConstantDefine.ACTIVE));
        // Assert.assertEquals(inActiveCobarNum,
        // cobarDao.getCobarCountByStatus(testClusterId,
        // ConstantDefine.IN_ACTIVE));
        // Assert.assertEquals(0, cobarDao.getCobarCountByStatus(testClusterId +
        // 1, ConstantDefine.ACTIVE));
        // Assert.assertEquals(0, cobarDao.getCobarCountByStatus(testClusterId +
        // 1, ConstantDefine.IN_ACTIVE));
