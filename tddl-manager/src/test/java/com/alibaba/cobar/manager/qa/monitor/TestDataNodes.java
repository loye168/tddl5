...
public class TestDataNodes extends TestCobarAdapter {
    ...
    private static final Logger   logger             = LoggerFactory.getLogger(TestDataNodes.class);
    private Connection            managerConnection  = null;
    private Connection            dmlConnection      = null;
    private List<DataNodesStatus> dataNodeStatusList = null;
     ...
     * first test switch @@dataSource poolName, then test switch @@dataSource
     * poolName:index
     */
    @Test
    public void testSwitchIndex() {
        ...
        // test first dataNode with multi-dataSources or last dataNode with
        // single dataSource
