...
import static com.alibaba.cobar.manager.util.ConstantDefine.TYPE_CLUSTER_INFO;
import static com.alibaba.cobar.manager.util.ConstantDefine.TYPE_CLUSTER_THROUGHPUT_INFO;
import static com.alibaba.cobar.manager.util.ConstantDefine.TYPE_COBAR_MEMORY_USAGE;
import static com.alibaba.cobar.manager.util.ConstantDefine.TYPE_INDEX;
import static com.alibaba.cobar.manager.util.ConstantDefine.TYPE_STATUS;
...
public class ClusterInstantPerfValueAjax implements HttpRequestHandler, InitializingBean {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ClusterInstantPerfValueAjax.class);
