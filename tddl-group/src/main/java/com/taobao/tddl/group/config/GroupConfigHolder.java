...
public class GroupConfigHolder extends AbstractConfigDataHolder {
    ...
    public void init() {
        ...
        try {
            ...
            throw new TddlNestableRuntimeException("Init SonConfigHolder Error, Class is : " + ATOM_CONFIG_HOLDER_NAME,
                e);
        }
    }
    ...
    private void initExtraConfigs() {
        ...
        extraConfKeys.add(getSqeuencefKey(appName));
    ...
    private String getSqeuencefKey(String appName) {
        return "com.taobao.tddl.sequence." + appName;
    }
