...
public abstract class UnitConfigDataHandler extends AbstractLifecycle implements ConfigDataHandler {
    ...
    protected UnitConfigDataHandler loadHandlerExtension() {
        UnitConfigDataHandler unitHandler = ExtensionLoader.load(UnitConfigDataHandler.class, ConfigDataMode.getMode()
            .getExtensionName());
    ...
    public String getData() {
        return getData(ConfigDataHandler.GET_DATA_TIMEOUT, ConfigDataHandler.FIRST_SERVER_STRATEGY);
    }
}
