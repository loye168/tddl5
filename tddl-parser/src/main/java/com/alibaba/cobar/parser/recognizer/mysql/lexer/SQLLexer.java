...
public class SQLLexer {
    ...
    /**
     * update {@link SQLLexer#stringValue} and
     * {@link SQLLexer#stringValueUppercase}. It is possible that {@link #sbuf}
     * be changed
     */
    ...
    public SQLLexer(char[] sql) throws SQLSyntaxErrorException{
        ...
        this.sql[this.eofIndex] = SQLLexer.EOI;
        scanChar();
        nextToken();
    }
    ...
    protected void scanNumber() throws SQLSyntaxErrorException {
        ...
        for (; scanChar() != SQLLexer.EOI; ++sizeCache) {
            switch (state) {
                case 0:
     ...
     * <code>"f"</code> in MySQL, but in this {@link SQLLexer}, it will be
