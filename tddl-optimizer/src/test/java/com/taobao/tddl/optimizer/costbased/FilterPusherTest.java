...
public class FilterPusherTest extends BaseOptimizerTest {
    ...
    public void test_where中非Group_OR条件不可下推() {
        ...
        JoinNode join = table1.join(table2);
        join.query("(TABLE1.ID>5 OR TABLE2.NAME<10) AND TABLE1.ID = TABLE2.ID");
        join.build();
        FilterPreProcessor.optimize(join, true, null);
        FilterPusher.optimize(join);
    ...
    public void test_where中Group_OR条件下推() {
        ...
        JoinNode join = table1.join(table2);
        join.query("(TABLE1.ID>10 OR TABLE1.ID<5) AND TABLE1.ID = TABLE2.ID");
        join.build();
        FilterPreProcessor.optimize(join, true, null);
        FilterPusher.optimize(join);

        Assert.assertEquals("(TABLE1.ID > 10 OR TABLE1.ID < 5)", join.getLeftNode().getWhereFilter().toString());
        Assert.assertEquals("(TABLE2.ID > 10 OR TABLE2.ID < 5)", join.getRightNode().getWhereFilter().toString());
    ...
    public void test_join条件_不满足group_or下推() {
        ...
        Assert.assertEquals(null, join.getLeftNode().getOtherJoinOnFilter());
        Assert.assertEquals(null, join.getRightNode().getOtherJoinOnFilter());
    ...
    public void test_join条件下推_groupOR混合条件推导下推() {
        ...
        Assert.assertEquals("((TABLE1.ID > 10 OR TABLE1.ID = 7) AND TABLE1.ID < 5)", join.getLeftNode()
            .getOtherJoinOnFilter()
            .toString());
        Assert.assertEquals("(TABLE2.ID < 5 AND (TABLE2.ID > 10 OR TABLE2.ID = 7))", join.getRightNode()
            .getOtherJoinOnFilter()
            .toString());
        Assert.assertEquals("TABLE1.ID = TABLE2.ID", join.getJoinFilter().get(0).toString());
    }
    ...
    public void test_join条件下推_GROUP_ON多级join() {
        ...
        Assert.assertEquals("TABLE1.NAME = TABLE2.NAME", ((JoinNode) nextJoin.getLeftNode()).getJoinFilter()
            .get(0)
            .toString());
        Assert.assertEquals("((TABLE1.NAME = 6 OR TABLE1.NAME > 10) AND TABLE1.ID > 5)",
            ((JoinNode) nextJoin.getLeftNode()).getLeftNode().getOtherJoinOnFilter().toString());
        Assert.assertEquals("(TABLE2.ID < 10 AND (TABLE2.NAME = 6 OR TABLE2.NAME > 10))",
            ((JoinNode) nextJoin.getLeftNode()).getRightNode().getOtherJoinOnFilter().toString());
